Version 1/070815 of FyreVM Core (for Glulx only) by David Cornelson begins here.
...
FyreVM Core ends here.

---- DOCUMENTATION ----

FyreVM Core is the base extension for Glulx+Channel IO web applications.
